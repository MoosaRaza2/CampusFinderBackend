...
//     callback(null, '../campusFrontend/public/Upload/');
//   },
...
//   destination: (req, file, callback) => {
//     callback(null, '../campusFrontend/public/CateringImages/');
//   },
//   filename: (req, file, callback) => {
//     callback(null, file.originalname);
//   },
...
//   res.send(req.rootUser);
// });
// router.post('/CreateMenus', upload.single('Picture'), async (req, res) => {
//   console.log(req.body);
