...
//       Times: Time,
//       CustomerEmail: req.rootUser.email,
//       CustomerID: req.rootUser._id,
//       CustomerName: req.rootUser.name,
//       PostID: PostID,
//     },
//   ];
//   console.log(array);
...
//   }
//   const array = [
//     { Username: CustomerName, CateringComment: Comment, Value: value },
//   ];
...
//       res.send({
//         result: arrays,
//         AllOrders: remainingArr,
//         UserResult: req.rootUser,
//       });
//     }
//   } catch (err) {
//     console.log(err);
...
//   const array = [
//     { Name: Name, Address: Address, Mobile: Mobile, Salary: Salary },
//   ];
...
// });
// router.get(
//   '/ViewEmployees/Edit/:id',
//   ManagmentAuthenticate,
//   async (req, res) => {
//     console.log(req.params.id);
//     try {
//       const emp = await ManagementUsers.findOne({ email: req.rootUser.email });
